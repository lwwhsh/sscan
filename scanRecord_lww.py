#!/usr/bin/env python
"""
implementation of scanning use Epics scan record, IOC running on the 141.223.55.114
"""
import epics
import threading
...
class Scan(epics.Device):
    ...
    def __init__(self, name, **kwargs):
        ...
        self.put('SMSG', '')
        ## disabled by LWW self.put('NPTS', 0)
        ## disabled by LWWfor i in range(1, NUM_TRIGGERS+1):
        ## disabled by LWW    self.put('T%iPV' % i, 'BL10C:scaler1.CNT')
        self.put('T1PV', 'BL10C:scaler1.CNT')    # Trigger 1 PV name.(scaler1 CNT PV name)
